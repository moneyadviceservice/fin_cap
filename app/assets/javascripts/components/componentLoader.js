...
define(['jquery', 'rsvp', 'utilities'], function ($, RSVP, utilities) {
    ...
    return {
        ...
        _checkForFailedInstantiations: function (results, initialisedList) {
            ...
            console.log('%%%%%%%%%%% _checkForFailedInstantiations CHECKING FAILURES %%%%%%%%%');

            $.each(results, function (idx, obj) {
                if ((obj.state === 'rejected') && (obj.reason.description === 'SINGLETON-DUPLICATE')) {
                    console.log('%%%%%%%%%%% obj failed >>> %%%%%%%%% ', obj);
        ...
        _listComponentsToCreate: function ($container, includeDeferred) {
            ...
            console.log('+++++++++++ Start from _listComponentsToCreate +++++++++++');
            ...
            console.log('+++++++++++ Return from _listComponentsToCreate +++++++++++');
        ...
        _instantiateComponents: function (componentsToCreate, instantiatedList) {
            console.log('@@@@@@@@@@@@@@ _instantiateComponents start @@@@@@@@@@@@@@');
            console.log('@@@@@@@ _instantiateComponents @@@@@@', arguments);

            var self = this;
            $.each(componentsToCreate, function (idx, componentData) {

                console.log('@@@@@@@@@@@@@@ _instantiateComponents calls @@@@@@@@@@@@@@');
        ...
        _instantiateComponent: function (componentName, $el, instantiated) {
            ...
            console.log('^^^^^^^^^^^^ _instantiateComponent start ^^^^^^^^^^^^ ');

            require([componentName], function (Constr) {

                console.log('_instantiateComponent ^^^^^^^^^^^^ ', componentName);
                ...
                if (!Constr.isSingleton || !self.components[componentName]) {
                    ...
                    console.log('_instantiateComponent Resolved  ###### ');
                } else {
                    instantiated.reject({
                    ...
                    console.log('_instantiateComponent Rejected  ###### ');
                }
            });

            console.log('######### _instantiateComponent End #######');
        },
        ...
        _initialiseComponents: function (components, initialisedList) {
            ...
            console.log('SECOND PASS >>>>>> _initialiseComponents ', components);
